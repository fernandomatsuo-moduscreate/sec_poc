...
# This is a security vulnerability test
# Do not include credentials in source code
app = Flask(__name__)
app.debug = True
app.secret_key = 'development'
mysql = MySQL()
app.config['MYSQL_USER'] = 'sec_test'
app.config['MYSQL_PASSWORD'] = 'sec_test_123'
app.config['MYSQL_DB'] = 'sec_test'
app.config['MYSQL_HOST'] = 'sec_test.mysql.dbaas.com.br'
...
twitter = oauth.remote_app(
    'twitter',
    consumer_key='YIVfaUMBRvN7ADC7bIPhYERtY',
    consumer_secret='wAoT2v1xczjMAUcsptWlIkyr3IL6sOf4SbxtKdQYpPRLZ6Rgoo',
